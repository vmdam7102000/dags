# dags/crypto/aggregate_crypto_ohlcv_8h_dag_dag.py
...
CONFIG = load_yaml_config("crypto_configs/ohlcv_8h.yml")["ohlcv_8h"]
DB_CFG = CONFIG["db"]
LOOKBACK_DAYS: int = int(DB_CFG.get("lookback_days", 30))
...
BUCKET_MINUTES = int(DB_CFG.get("bucket_minutes", 480))
BUCKET_MS = BUCKET_MINUTES * 60 * 1000
SCHEDULE = CONFIG.get("schedule", "15 */8 * * *")

logger = logging.getLogger("aggregate_crypto_ohlcv_8h_dag")
...
with DAG(
    dag_id="aggregate_crypto_ohlcv_8h_dag",
    description="Aggregate 3m OHLCV candles into 8h timeframe",
    default_args={
        "owner": "crypto-data",
