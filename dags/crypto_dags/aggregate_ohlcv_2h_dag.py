# dags/crypto/aggregate_crypto_ohlcv_2h_dag_dag.py
...
CONFIG = load_yaml_config("crypto_configs/ohlcv_2h.yml")["ohlcv_2h"]
DB_CFG = CONFIG["db"]
...
BUCKET_MINUTES = int(DB_CFG.get("bucket_minutes", 120))
BUCKET_MS = BUCKET_MINUTES * 60 * 1000
SCHEDULE = CONFIG.get("schedule", "10 */2 * * *")

logger = logging.getLogger("aggregate_crypto_ohlcv_2h_dag")
...
with DAG(
    dag_id="aggregate_crypto_ohlcv_2h_dag",
    description="Aggregate 3m OHLCV candles into 2h timeframe",
    default_args={
        "owner": "crypto-data",
