# dags/sp500_stock_dags/sp500_stock_eod_prices_ingest_dag.py
...
CONFIG = load_yaml_config("sp500_stock_configs/sp500_eod_prices.yml")["sp500_eod_prices"]
API_CFG = CONFIG["api"]
DB_CFG = CONFIG["db"]
...
with DAG(
    dag_id="sync_sp500_eod_stock_prices_dag",
    description="Sync S&P 500 EOD stock prices from EODHD API to Postgres",
    default_args={
